...
| M1-D-A4-RENDER | M1 | W2 | Agent D | One-page A4 render path and print-fit verification | M1-C-LAYOUT-BOOTSTRAP | P0 | in_progress | dispatch ready: docs/orchestration/dispatches/M1-D-A4-RENDER-W2.md (launch after M1-C acceptance) | 2026-09-24 |
