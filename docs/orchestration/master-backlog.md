...
| M1-C-LAYOUT-BOOTSTRAP | M1 | W1 | Agent C | Static edition composition with fake HU data | M0-A-PLATFORM-SMOKE, M0-B-DATA-SMOKE | P1 | in_progress | dispatch prepared: docs/orchestration/dispatches/M1-C-LAYOUT-BOOTSTRAP-W1.md | 2026-09-24 |
