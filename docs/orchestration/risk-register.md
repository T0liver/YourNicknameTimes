...
| R-004 | Performance | Pi 3B+ render/runtime latency may exceed morning window | High | Medium | Agent D | Benchmark render and worker timings in M1/M3; optimize templates and caching | Earlier schedule start or reduced content density | M1-C accepted; M1-D now active to produce one-page A4 proof + Pi render-time measurement | M3 end | monitoring | 2026-09-24 |
